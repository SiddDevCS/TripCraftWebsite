...
export default function LegalPage() {
  ...
  return (
    <div className="container mx-auto px-6 py-16">
      ...
      {/* Content */}
      <div className="bg-white rounded-lg shadow-md p-6 md:p-10 max-w-4xl mx-auto">
        {activeTab === 'privacy' && (
          <div>
            <h2 className="text-2xl font-bold text-gray-800 mb-6">Privacy Policy</h2>
            <p className="text-gray-600 mb-4">Last Updated: March 25, 2025</p>
            ...
            <div className="space-y-6">
              ...
              <section>
                <h3 className="text-xl font-semibold text-gray-800 mb-3">Interpretation and Definitions</h3>
                <h4 className="text-lg font-semibold text-gray-800 mb-2">Interpretation</h4>
                <p className="text-gray-600">
                  The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
                </p>
                
                <h4 className="text-lg font-semibold text-gray-800 mt-4 mb-2">Definitions</h4>
                <p className="text-gray-600">
                ...
                <ul className="list-disc pl-6 mt-2 text-gray-600 space-y-2">
                  ...
                  <li><strong>Application</strong> refers to TripCraft, the software program provided by the Company.</li>
                  <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to TripCraft.</li>
              ...
              <section>
                <h3 className="text-xl font-semibold text-gray-800 mb-3">Collecting and Using Your Personal Data</h3>
                <h4 className="text-lg font-semibold text-gray-800 mb-2">Types of Data Collected</h4>
                
                <h5 className="text-base font-semibold text-gray-800 mt-4 mb-2">Personal Data</h5>
                <p className="text-gray-600">
                  While using Our Service, We may ask You to provide Us with certain personally identifiable information that can be used to contact or identify You. Personally identifiable information may include, but is not limited to:
                </p>
                
                <h5 className="text-base font-semibold text-gray-800 mt-4 mb-2">Usage Data</h5>
                <p className="text-gray-600">
              ...
              <section>
                ...
                <h4 className="text-lg font-semibold text-gray-800 mb-2">Business Transactions</h4>
                <p className="text-gray-600">
          ...
          <div>
            ...
            <div className="space-y-6">
              <section>
                ...
                <p className="text-gray-600">
                  By downloading, accessing, or using the TripCraft application, you agree to be bound by these Terms of Use. If you do not agree to these Terms of Use, you should not access or use the application.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-gray-600">
                  Subject to these Terms of Use, TripCraft grants you a limited, non-exclusive, non-transferable, revocable license to download, install, and use the application for your personal, non-commercial purposes.
                </p>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc pl-6 mt-2 text-gray-600 space-y-2">
                  ...
                  <li>To impersonate or attempt to impersonate TripCraft, a TripCraft employee, another user, or any other person or entity</li>
              ...
              <section>
                ...
                <p className="text-gray-600">
                  The application and its entire contents, features, and functionality (including but not limited to all information, software, text, displays, images, video, and audio, and the design, selection, and arrangement thereof) are owned by TripCraft, its licensors, or other providers of such material and are protected by United States and international copyright, trademark, patent, trade secret, and other intellectual property or proprietary rights laws.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-gray-600">
                  We may terminate or suspend your access to the application immediately, without prior notice or liability, for any reason whatsoever, including without limitation if you breach these Terms of Use.
                </p>
              </section>
              ...
              <section>
                <h3 className="text-xl font-semibold text-gray-800 mb-3">Contact Information</h3>
                <p className="text-gray-600">
                  If you have any questions about these Terms of Use, please contact us at: siddnative@gmail.com
                </p>
              </section>
            </div>
          </div>
